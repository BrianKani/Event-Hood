			...
			<nav class="navbar navbar-default navbar-fixed-top">
				<div class="container">
					<div class="navbar-header page-scroll">
						...
						<h1><a class="navbar-brand" href="index.jsp">Events</a></h1>
					</div> 
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a class="hvr-sweep-to-right" href="events.jsp">Events</a></li>
							<li class="dropdown">
									<a href="#" class="dropdown-toggle hvr-sweep-to-right" data-hover="Pages" data-toggle="dropdown">Pages <b class="caret"></b></a>
									<ul class="dropdown-menu">
										<li><a class="hvr-sweep-to-right" href="icons.jsp">Icons</a></li>
										<li><a class="hvr-sweep-to-right" href="typography.jsp">Short Codes</a></li>
									</ul>
							  </li>
			...
			<div class="ser_w3l">  
			  ...
			  <div class="outer-wrapper">
				<div class="inner-wrapper">
				  ...
				  <div class="content-wrapper">
					<h4>Sangeet</h4>
					<p>full of enjoyments and joy</p>
				  </div>
				</div>
			  </div>
			  <div class="outer-wrapper">
				<div class="inner-wrapper">
				  ...
				  <div class="content-wrapper">
					<h4>Weddings</h4>
					<p>?Marriage is like twirling a baton, turning a handspring, or eating with chopsticks: It looks easy until you try it.?</p>
				  </div>
				</div>
			  </div>
			  <div class="outer-wrapper">
			  ...
			  <div class="outer-wrapper">
				<div class="inner-wrapper">
				  ...
				  <div class="content-wrapper">
					<h4>Catering</h4>
					<p>tasty delicious food to make day more better</p>
				  </div>
				</div>
			  </div>
			  <div class="outer-wrapper">
				<div class="inner-wrapper">
				  ...
				  <div class="content-wrapper">
					<h4>Promotions</h4>
					<p>celebrate the achievements in much better way</p>
				  </div>
				</div>
			  </div>
			  <div class="clearfix"></div>
		...
		<h3 class="heading-agileinfo">Services<span>Events is a professionally managed Event</span></h3>
			...
			<div class="showcase showcase--inverted">
				<div class="desc">
					...
					<h4>Wedding</h4>
					<p>Marriage is like twirling a baton, turning a handspring, or eating with chopsticks: It looks easy until you try it
					</p>
				</div>
			...
			<div class="showcase showcase--inverted">
				<div class="desc">
					...
					<h4>Catering</h4>
					<p>tasty delicious food to make day more better
					</p>
				</div>
	...
	<div class="footer-top">
		<div class="container">
			<div class="col-md-3 foot-left">
				...
				<p>our team will give best things as long as possible</p>
			</div>
			<div class="col-md-3 foot-left">
					<h3>Get In Touch</h3>
					<p>you can get in touch with contanct and email both they are as give below</p>
				
						<div class="contact-btm">
							<span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>
							<p>90 Street, banglore,  34789.</p>
						</div>
						<div class="contact-btm">
						...
						<div class="contact-btm">
							...
							<p><a href="mailto:example@email.com">km@example.com</a></p>
						</div>
						<div class="clearfix"></div>
